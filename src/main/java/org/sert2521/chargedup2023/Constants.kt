...
object PhysicalConstants {
    const val halfSideLength = 0.0

    const val powerEncoderMultiplierPosition = 0.0
    const val powerEncoderMultiplierVelocity = 0.0

    const val angleEncoderMultiplier = 0.0
